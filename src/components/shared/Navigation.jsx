                ...
                <div className="user-dropdown-menu">
                  <div className="dropdown-header">
                    <div className="dropdown-user-info">
                      ...
                      <div>
                        <div className="dropdown-user-name">{user.name || user.email}</div>
                        <div className="dropdown-user-role">{getRoleDisplayName(role)}</div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mobile-user-info">
            <div className="mobile-user-details">
              ...
              <div>
                ...
                <div className="mobile-user-role">{getRoleDisplayName(role)}</div>
              </div>
            </div>
            <button onClick={handleLogout} className="btn btn-text logout-btn">
              Sign Out
            </button>
          </div>
        )}
